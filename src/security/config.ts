...
export const SECURITY_PROFILES: Record<SecurityLevel, SecurityProfile> = {
  ...
  [SecurityLevel.BALANCED]: {
    ...
    allowFunctionCalls: [
      ...
      "getComputedStyle", "getBoundingClientRect", "focus", "blur",
  ...
  [SecurityLevel.PERMISSIVE]: {
    ...
    allowFunctionCalls: [
      ...
      "getElementsByClassName", "getElementsByTagName",
      "getComputedStyle", "getBoundingClientRect", "focus", "blur",
      "scrollIntoView", "dispatchEvent", "click", "submit",
...
export function getSecurityConfig(level: SecurityLevel = SecurityLevel.BALANCED): Partial<SecurityConfig> {
...
export function detectSecurityLevel(): SecurityLevel {
  ...
  if (mcpSecurity) {
    switch (mcpSecurity) {
      case "strict": return SecurityLevel.STRICT;
      case "balanced": return SecurityLevel.BALANCED;
      case "permissive": return SecurityLevel.PERMISSIVE;
      case "development": return SecurityLevel.DEVELOPMENT;
    }
  }
